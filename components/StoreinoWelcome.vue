...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="flex justify-center pt-8 sm:pt-0" href="https://storeino.dev" target="_blank">
        <img width="218" height="45" src="https://storeno.b-cdn.net/stores/8-2023/1691067073456.webp" alt="" />
      </a>
      
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/Abdelali-ErRafik/new-theme" target="_blank"><svg
        ...
        <a href="https://twitter.com/_storeino" target="_blank"><svg
